      ...
      <main className="container relative z-10 mx-auto px-6 py-16 md:px-12 lg:px-20 lg:py-24">
        ...
        <section className="mb-16 text-center lg:mb-24">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-6">
            PHOENIX-F1: <span className="bg-gradient-to-r from-pink-400 via-purple-500 to-indigo-500 bg-clip-text text-transparent">Firefighting Defense Rover</span>
          </h1>
        ...
        {/* 3. CORE PHILOSOPHY */}
        <section className="mb-16 text-center lg:mb-24">
          <blockquote className="mx-auto max-w-4xl rounded-xl border border-purple-500/30 bg-gradient-to-r from-purple-900/20 via-indigo-900/20 to-purple-900/20 p-8 backdrop-blur-sm">
