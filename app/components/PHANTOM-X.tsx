...
import Navbar from '@/app/components/Navbar'; // আপনার প্রজেক্টের সঠিক পাথ অনুযায়ী এডজাস্ট করুন
...
export default function PhantomXPage() {
  return (
    <div className="relative min-h-screen text-[#111827] dark:text-[#f8fafc] transition-colors duration-500">
      ...
      <main className="container relative z-10 mx-auto px-6 py-16 md:px-12 lg:px-20 lg:py-24">
        
        {/* 2. HERO SECTION & PROJECT OVERVIEW */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-10">
            ...
            <div className="rounded-xl border border-slate-300 dark:border-slate-800 bg-[#b1cfee]/20 dark:bg-[#1b263e]/50 backdrop-blur-sm p-5 text-center">
              ...
              <div className="text-lg font-semibold text-purple-600 dark:text-purple-400 flex items-center justify-center gap-2">
                <CheckCircle className="h-5 w-5" /> 100% Operational
              </div>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Rigorous Testing Complete</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 lg:mb-24">
          <div className="rounded-2xl border border-slate-300 dark:border-slate-800 bg-[#b1cfee]/20 dark:bg-[#1b263e]/40 backdrop-blur-md p-8 lg:p-12">
            ...
            <div className="space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed">
              <p>
                Every year during national defense exhibitions like <strong className="text-purple-400">&ldquo;Onirban&rdquo;</strong>, the absence of indigenous high-tech robotics tailored for modern tactical intelligence operations becomes apparent. Concurrently, news headlines frequently highlight tragic casualties from bomb blasts and landmine explosions.
              </p>
              
              <div className="mt-6 border-l-4 border-purple-500/80 bg-purple-500/5 p-4 rounded-r-lg">
                <h4 className="font-semibold text-slate-900 dark:text-slate-100 mb-1">Subterranean Threat Factor</h4>
                <p className="text-sm">
                  Hidden landmines planted by border forces and explosives left behind by hostile groups continue to threaten civilian lives and military personnel. Driven by these severe real-world challenges, PHANTOM-X was conceptualized to eliminate human risk in lethal environments.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-16 lg:mb-24">
          <h2 className="text-3xl font-bold mb-8 text-center sm:text-left flex items-center gap-3">
            <Cpu className="h-7 w-7 text-emerald-500" /> Technical Architecture & Specs
          </h2>
        ...
        {/* 7. SCIENCE FAIR / EXHIBITION HIGHLIGHTS (2 PICS) */}
        <section className="mb-16 lg:mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Photo 1: Science Fair Presentation */}
            <div className="group overflow-hidden rounded-xl border border-slate-300 dark:border-slate-800 bg-[#b1cfee]/20 dark:bg-[#1b263e]/40 p-2 backdrop-blur-sm">
              <div className="overflow-hidden rounded-lg">
                <Image
                  src="/images/phantom-fair-1.jpg"
                  alt="PHANTOM-X Exhibition Showcase"
                  width={1200}
                  height={768}
            ...
            {/* Photo 2: Live Prototype Testing */}
            <div className="group overflow-hidden rounded-xl border border-slate-300 dark:border-slate-800 bg-[#b1cfee]/20 dark:bg-[#1b263e]/40 p-2 backdrop-blur-sm">
              <div className="overflow-hidden rounded-lg">
                <Image
                  src="/images/phantom-fair-2.jpg"
                  alt="PHANTOM-X Prototype Testing"
                  width={1200}
                  height={768}
                  className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-300"
                />
          ...
          <div className="rounded-xl border border-slate-300 dark:border-slate-800 bg-[#b1cfee]/20 dark:bg-[#1b263e]/40 p-8 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Aerial companion drone integration for extended flight, mapping, and surveillance.</p>
              </div>
              <div>
                <h4 className="font-semibold text-slate-900 dark:text-slate-100 mb-1">b. AI Aim Bot System</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400">Automated threat acquisition and target-locking via computer vision.</p>
              </div>
              <div>
                <h4 className="font-semibold text-slate-900 dark:text-slate-100 mb-1">c. Advanced Optics Upgrade</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400">Upgrading thermal and night-vision range for extended fidelity.</p>
              </div>
            </div>
          </div>
        </section>
